...
Dependencies: flask, gunicorn, pyotp, requests (all already installed)
...
```
    payload = {
        ...
        "pc": product, "pf": "N", "pr": "0", "pt": order_type,
        "qt": str(qty), "rt": "DAY", "tp": "0", "ts": symbol,
...
result = place_order(trading_token, sid, server_id, symbol, action,
                     qty, exchange, product, order_type)
if result:
